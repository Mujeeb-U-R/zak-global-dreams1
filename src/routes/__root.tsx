...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premier corporate visa & travel consultancy in Peshawar. Work permits, visit visas, group tours and student visas — 99% approval rate." },
      { name: "author", content: "ZAK Consultants" },
      { property: "og:title", content: "ZAK Consultants (Pvt.) Ltd." },
      { property: "og:description", content: "Your Trusted Partner for Global Visa Solutions." },
